        ...
        <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden" style={{ background: "#050714" }}>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    style={{ background: "rgba(249, 168, 212, 0.15)", filter: "blur(120px)" }}
                />
                <motion.div
                ...
                <motion.div
                    ...
                    style={{ background: "rgba(103, 232, 249, 0.08)", filter: "blur(120px)" }}
                />
            </div>
            ...
            >
                ...
                <div className="flex items-center gap-3 mb-10">
                    <motion.div
                        ...
                        style={{
                            background: "linear-gradient(135deg, var(--echo-blush), var(--echo-lavender))",
                            boxShadow: "0 8px 24px rgba(249, 168, 212, 0.3)",
                        }}
                    >
                ...
                >
                    <div
                        ...
                        style={{
                            background: "linear-gradient(135deg, rgba(249,168,212,0.04), transparent, rgba(196,181,253,0.04))",
                        }}
                    />
                    ...
                    <div className="relative z-10">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 text-sm mt-1.5">Set up your secure workspace in seconds.</p>
                        </div>

                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                <Label className="text-slate-500 text-[9px] uppercase font-bold tracking-[0.2em]">Full Name</Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-11 h-13 bg-white/4 border-white/8 text-white rounded-xl focus:border-violet-500/40 transition-all placeholder:text-slate-600 text-sm"
                                    />
                                </div>
                            </div>
                            ...
                            <motion.button
                                ...
                                style={{
                                    background: "linear-gradient(135deg, var(--echo-blush), var(--echo-lavender))",
                                    color: "#fff",
                                    boxShadow: "0 8px 24px rgba(249, 168, 212, 0.25)",
                                }}
                            >
                                {isLoading ? (
